...
return require("packer").startup(
	function(use)
		...
		use {"petertriho/nvim-scrollbar", disable = false, -- scrollbar which shows search resutls   and errors
			config=function()
		...
		use {'beauwilliams/focus.nvim', disable=false,  -- autoresize windows to gold ration - brokens with scroll
			config = function() require("focus").setup({ enable = true})  end}
		...
		use { "hrsh7th/nvim-cmp", disable=false,
			requires = { "hrsh7th/cmp-buffer", "hrsh7th/cmp-nvim-lsp", "hrsh7th/cmp-path", "hrsh7th/cmp-cmdline",
				"hrsh7th/cmp-nvim-lua",  'quangnguyen30192/cmp-nvim-ultisnips', 'hrsh7th/cmp-calc', 'lukas-reineke/cmp-rg',
				'hrsh7th/cmp-nvim-lsp-signature-help', 'uga-rosa/cmp-dictionary', 'f3fora/cmp-spell'}, --"hrsh7th/cmp-vsnip",
		...
		use {'nvim-telescope/telescope.nvim',
			requires = {{'nvim-lua/popup.nvim'}, {'nvim-lua/plenary.nvim'}, {'tom-anders/telescope-vim-bookmarks.nvim'}, 'nvim-telescope/telescope-file-browser.nvim'},
		...
		--find and replace ? -------------------------------------------------------------------------------------------------------
		use {
			'VonHeikemen/searchbox.nvim', disable=false,
		...
		use {'andymass/vim-matchup',disable = true, -- increase power of % - slow as hell
		...
		use { "danymat/neogen",  -- generate code docs
