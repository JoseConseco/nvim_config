...
let g:which_key_map['<'] = [ ':Telescope buffers',    'Switch Buffer' ]
let g:which_key_map["%"] = [ ':<C-o><CR>',           'Switch to last buffer' ] "<plug>bufftabs
...
let g:which_key_map.c = {
			...
			\ 's': {
			\ 'name': '+Spell',
			\ 't' : [':Telescope spell_suggest',         'Suggest tele'],
			\ 'S' : [':setlocal spell! spelllang=en_us', 'VIM spellchecking'],
			\ 'f' : [':ZT',                              'Spelunker ON/OFF (ZT)'],
			\ 's' : [':Zl',                              'Spelunker Suggest (Zl)'],
			\ 'a' : [':Zw',                              'Add selected word'],
			\},
			\ 'f': {
			\ 'name': '+Folds',
			\ 'f' : [':call v:lua.conditional_fold()',   'Toggle all ON/OFF'],
			\ 'M' : [':zM',   'Close all(zM)'],
			\ 'R':  [':zR',   'Open all (zR)'],
			\ '+' : [':zm',   'inc+1 (zm)'],
			\ '-' : [':zr',   'dec-1 (zr)'],
...
let g:which_key_map.f = {
			...
			\ 'r' : [':confirm e',                            'Reload File(e!)'],
			\ 'f' : [':Telescope file_browser',               'File Browser (fuzzy)'],
...
let g:which_key_map.l = {
			...
			\ 't' : [':LspTroubleToggle',                'Lsp Trouble Toggle'],
			\ 'S' : {
			\ 'name': '+LSPSaga',
...
let g:which_key_map.w = {
			\ 'name' : '+Window' ,
			\ '=' : ['<C-w>='           , 'Equalize(=)'],
			\ '>' : [':vertical resize +5'           , 'Increase(>)'],
			\ '<' : [':vertical resize -5'           , 'Decrease(<)'],
