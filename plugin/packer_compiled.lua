...
_G.packer_plugins = {
  ...
  ["lsp_spinner.nvim"] = {
    loaded = true,
    path = "/home/bartosz/.local/share/nvim/site/pack/packer/start/lsp_spinner.nvim",
